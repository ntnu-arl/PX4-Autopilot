...
class NeuralControlConstrained
{
public:
	NeuralControlConstrained(int n_motors);
	~NeuralControlConstrained() = default;
...
private:
  ...
  Eigen::VectorXf _bias_allocation_net_layer_3;
  Eigen::MatrixXf _weight_allocation_net_layer_3;
  Eigen::VectorXf _bias_allocation_net_layer_4;
  Eigen::MatrixXf _weight_allocation_net_layer_4;
